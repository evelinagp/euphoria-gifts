...
public interface GiftService {
   ...
   // List<GiftViewModel> getAllGiftsByCategory(String category);
...
//   GiftServiceModel mapGiftServiceModel(@Valid GiftServiceModel giftServiceModel) ;

//    void update(GiftServiceModel giftServiceModel);

    void updateGift(GiftServiceModel giftServiceModel) throws IOException;


//    GiftServiceModel findById(Long id);
}
