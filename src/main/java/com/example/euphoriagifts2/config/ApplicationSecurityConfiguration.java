    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.
                ...
                // everyone can login and register
                        ...
                        antMatchers("/", "/users/login", "/users/register", "/gifts/**", "/about", "/categories", "/contacts", "/api/{giftId}/comments", "/cart").permitAll().
                // pages available only for users
//                            antMatchers("/pages/contacts").hasRole(RoleNameEnum.USER.name()).
