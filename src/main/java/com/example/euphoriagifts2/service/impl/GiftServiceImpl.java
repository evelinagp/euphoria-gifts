...
public class GiftServiceImpl implements GiftService {
    ...
    public GiftServiceImpl(GiftRepository giftRepository, UserService userService, PictureService pictureService, ModelMapper modelMapper, CategoryService categoryService, CloudinaryService cloudinaryService) {
    ...
    public void deleteGiftById(Long id) {
        ...
        try{
            ...
            System.out.println(message + " because the gift is included in order!");
        }
    }
