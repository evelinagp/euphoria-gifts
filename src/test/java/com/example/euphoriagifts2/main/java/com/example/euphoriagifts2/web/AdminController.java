...
//    }
    ...
    public String addFile(@Valid GiftAddBindingModel giftAddBindingModel,
                          BindingResult bindingResult, RedirectAttributes redirectAttributes,
...
//        boolean isUserExist = this.userService.existByUsername(username);
//        if (isUserExist) {
