...
public class PictureController {
    ...
    public PictureController(CloudinaryService cloudinaryService, PictureRepository pictureRepository, PictureService pictureService, GiftService giftService) {
